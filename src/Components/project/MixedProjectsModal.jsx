...
export default function MixedProjectsModal({ isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8" onClick={onClose}>
            ...
            <div className="sk relative w-full max-w-6xl max-h-[90vh] bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="sk p-6 overflow-y-auto max-h-[calc(90vh-100px)]">
