...
export default function Contact() {
  return (
    <div id="contact" className="sk contact overflow-auto relative sm:rounded-3xl sm:my-8 sm:mr-12">
      ...
      <div className="sk ref_link card flex p-6 justify-center gap-4">
        <div className="sk group p-3 border-2 rounded-xl border-rose-500 border-opacity-50 hover:border-opacity-100 transition-opacity">
